...
<main class="container">
	<div>
		...
		<div class="wrapper col-sm-6 height-l5-px">
			<div class="wrapper header-wrapper width-max-pr height-max-pr" style="background-image: url(../../images/phoneSecured.jpg)">
				<div class="wrapper-content-overlay text-center" style="padding-top: 15%;">
					<h3>Tout commence par un coup de téléphone</h3>
					<div class="btn-link-danger"><a href="contact.php">Contactez-nous</a></div>
				</div>
			</div>
	...
	<div class="col-sm-12 clr-notis txt-clr-danger text-center space-top-l3-px space-top-in-l1-px space-bottom-l2-px" style="font-size: 80px;">
		<h3>Découvrez nos produits de qualité</h3>
	...
	<div class="vertical-space-l1-pr">
		<div class="col-sm-6" id="CCTV">
			<h1 class="title-small txt-italic bottom-line-separator">CCTV (Camera de Surveillance)</h1>
			<p class="txt-notis" style="font-size: 1.2em;">
			Nous mettons en votre disposition des matériels de surveillance pour votre entière sécurité. Nos matériels présentent les caractéristiques suivantes :</p>
			<ul style="font-size: 1.19em;">
				<li>Caméras analogique pour un circuit totalement fermé ; caméras IP pour des systèmes à longue distance ou système de surveillance en réseau</li>
				<li>Image full HD jusqu’à 5 Méga pixel</li>
				<li>Caméras Jour/nuit, intérieures ou extérieures ou caméras totalement IR pour une parfaite visualisation de nuit</li>
				<li>Tous les designs de caméras pour tout type de sites, bâtiments, hôtels, villas, etc. : caméra compact, dôme, mini- dôme, mini-caméra, caméra 360°</li>
				<li>Système d’enregistrement selon les besoins : jours, semaines, mois,... jusqu’à 6 mois d’enregistrement non-stop ;</li>
				<li>Détection de mouvement, programmation d’enregistrement</li>
				<li>Caméras mobiles pour véhicule de service, bus, camion pour des longues distances</li>
				<li>Visualisation à distance à partir d’un ordinateur, partout dans le monde ou sur Smartphone (IOs ou Android).</li>
				<li>Monitoring relié à un centre de contrôle privé ou à un des centres de contrôle ISS pour analyse d’images et appel d’urgence</li>
				<li>Caméras thermique longue portée (500 m) pour les grands espaces tels que les sites miniers</li>
				<li>Système de vidéo analyse ultra avancée avec détection de présence humaine</li>
				<li>Equipements intégrables à la plateforme VIGIPLUS</li>
			</ul>
		</div>
		<div class="col-sm-6 text-center">
			...
			<div class="wrapper col-sm-12 col-md-6 height-l5-px">
				<img src="../../images/camer.jpg" class="height-max-pr">
			</div>
	...
	<div class="col-sm-6" id="trasage">
		...
		<div class="col-sm-6 text-center">
			...
			<div class="wrapper col-sm-12 col-md-6 height-l5-px">
				<img src="../../images/shutterstock_530752207-290x360.jpg" class="height-max-pr">
			</div>

...
<header>
	...
	<div class="wrapper header-wrapper width-max-pr height-l9-px" style="background-image: url(../../images/security-265130__340.jpg)">
	    ...
	    <div class="txt-notis space-left-in-l6-pr space-right-in-l2-pr wrapper-content-overlay" style="padding-top: 8%;">
	    	...
	    	<h4>Une société innovante qui répond à des solutions adaptées à vos besoins dans toutes les questions liées à la sécurité !</h4>
	    </div>
	</div>
</header>
...
<main>
	...
	<div class="container cool-div-first">
        ...
        <div class="wrapper hidden-md height-l7-px col-md-4 no-horizontal-space-in clr-whiteblack" id="whoUs">
            <div class="text-center horizontal-space-l3-px">
                <div>
                    <h3 class="no-space-bottom">QUI SOMMES-NOUS ?</h3>
                    <span class="txt-notis">Découvrez l'Integrated Systems & Services</span>
                    <p><br>ISS est une société innovante qui répond avec des solutions adaptées aux besoins de ses clients dans toutes les questions liées à la sécurité électronique, la télécommunication, le personnel, le suivi des véhiculeles, panneau de contrôle, le contrôle de réservoir de carburant et le backup électrique.</p>
                </div>
	...
	<section class="bandeau-avantages space-top-l1-pr">
		...
		<div class="wrapper container-avantages">
			...
			<div class="text-center clr-info vertical-space-in-l2-px" id="avantages">
				<h1 class="title-small">AVANTAGES DE NOS SOLUTIONS</h1>
			...
			<div class="col-sm-6 col-md-3 avantage text-center">
				...
				<div>
					<h3 class="no-space-top">Synergie des systèmes</h3>
					<p>Diminution conséquentes des effectifs statiques, grâce à la synergie des systèmes techniques et humains.</p>
				</div>
	        </div>
	        ...
	        <div class="col-sm-6 col-md-3 avantage text-center">
				...
				<div>
					...
					<p>Automatisation et protocole réduisant l’erreur humaine par une chaine de réactions précises des forces d’intervention diverses à partir d’ un centre de contrôle.</p>
				</div>
	        </div>
	...
	<section id="powerUs">
		<div class="wrapper height-l9-px space-top-in-l1-px text-center" style="margin-top: 50px;margin-bottom: 20px; background-color: #3B4B4F; color:#9ABDC6;">
			...
			<h2 class="title-small no-vertical-space">NOS FORCES</h2>
			<span class="txt-notis hidden-xs title-mini no-decoration">NOUS SOMMES VOTRE MEILLEUR CHOIX</span>
			<h4 class="txt-notis visible-xs no-decoration">NOUS SOMMES VOTRE MEILLEUR CHOIX</h4>
		</div>
	</section>
	...
	<section id="materiels">
		...
		<div class="col-sm-6">
			...
			<a href="matos.php#CCTV" class="link-materiels-img">
				<div class="col-sm-6 div-img">
					<div class="wrapper width-max-pr height-l4-px" style="background-image: url(../../images/cmer.jpg)">
	...
	<section class="oursPartener" id="oursPartener">
		<div class="txt-clr-primary text-center">
			<h1 class="title-small">NOS PARTENAIRES ET CLIENTS</h1>
			<p class="text-center">
				<span class="txt-notis">Voici une selection de nos partenaires et clients</span>
				<br><i class="text-center fa fa-chevron-down" style="font-size : 30px;"></i>
			</p>
		</div>
